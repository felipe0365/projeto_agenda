...
class ContactForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if first_name == last_name:
            msg = ValidationError('Primeiro nome não pode ser igual ao último', code='invalid')
...
class RegisterForm(UserCreationForm):
    ...
    def clean_email(self):
        ...
        if User.objects.filter(email=email).exists():
            self.add_error('email', ValidationError('Já existe este email cadastrado.', code='invalid'))
